...
<body id="home">
	...
	<div class="section" id="about">
		<div class="sectionInner text">
			...
			<div class="padLeft">
			    <p>Next Hop is a club at the Rochester Institute of Technology (RIT) focused on networking and systems administration. NextHop is all about moving information and managing different services that run on a network.</p>
