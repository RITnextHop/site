...
<body id="home">
	...
	<div class="section" id="about">
		...
		<!--<p><strong><i class="fa fa-clock-o fa-2x"></i> Reminder that our PXE boot build it night is tonight, Thursday 4/30 at 7pm in 70-2320.  Hope to see you there!</strong></p>
		<hr>-->
			...
			<div class="fiftyFloat">
				...
				<div class="padLeft">
					...
					<ul>
						...
						<li>Treasurer: <a href="mailto:<?php echo $treasurer_email; ?>"><?php echo $treasurer_fullName; ?></a><br /><span class="major"><?php echo $treasurer_majorYear; ?></span></li>
					</ul>
					<h2>Advisor</h2>
					<ul>
